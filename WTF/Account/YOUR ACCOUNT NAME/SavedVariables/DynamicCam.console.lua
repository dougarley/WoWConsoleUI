...
DynamicCamDB = {
	["profileKeys"] = {
		["Ramaniscence - Bleeding Hollow"] = "Priest Native Controller",
	},
	["profiles"] = {
		["Console Immersion (Tauren)"] = {
			["version"] = 2,
			["firstRun"] = false,
			["reactiveZoom"] = {
				["enabled"] = true,
		...
		["Priest Native Controller"] = {
			...
			["situations"] = {
				...
				["005"] = {
					...
					["cameraCVars"] = {
						["test_cameraOverShoulder"] = 3.600000000000001,
						["test_cameraTargetFocusInteractEnable"] = 1,
						["test_cameraHeadMovementStrength"] = 0.5,
						["test_cameraTargetFocusEnemyEnable"] = 1,
					},
